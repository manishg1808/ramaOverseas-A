...
const Services = () => {
  const digitalMarketing = [
    { icon: 'ri-focus-3-line', title: 'SEO Optimization', desc: 'Improve rankings and organic traffic with on-page, off-page, and technical SEO.' },
    { icon: 'ri-bar-chart-line', title: 'PPC Management', desc: 'High-ROI Google & Meta Ads campaigns with conversion tracking.' },
    { icon: 'ri-smartphone-line', title: 'Social Media Growth', desc: 'Content strategy, calendar, and performance analytics across platforms.' },
    { icon: 'ri-palette-line', title: 'Branding & Strategy', desc: 'Brand identity, messaging, and full-funnel marketing strategy.' },
  ]

  const cyberSecurity = [
    { icon: 'ri-shield-check-line', title: 'Firewall Setup', desc: 'Enterprise-grade perimeter security and policy hardening.' },
    { icon: 'ri-search-line', title: 'Security Audit', desc: 'VAPT, compliance checks, and remediation roadmap.' },
    { icon: 'ri-lock-password-line', title: 'Threat Protection', desc: 'Endpoint, email, and network threat detection and response.' },
    { icon: 'ri-database-2-line', title: 'Data Recovery', desc: 'Backup strategy, DR drills, and rapid recovery playbooks.' },
  ]
