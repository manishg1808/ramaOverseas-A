  ...
  return (
    <div className="pt-24">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <span className="inline-flex items-center gap-1 text-[10px] mt-1 px-2 py-0.5 rounded-full bg-cyan-50 text-primary-blue border border-cyan-100">🛡️ Verified Client</span>
                            </div>
                          </div>
                          <div className="text-xl text-primary-blue/30">“</div>
                        </div>
                        <div className="mt-3 text-amber-500 text-xs" aria-label="5 star rating">
                          <span>★ ★ ★ ★ ★</span>
                        </div>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
            {[
              { title: 'Dual Expertise', desc: 'Marketing + Cybersecurity under one roof.', icon: '🔐' },
              { title: 'Proven Results', desc: 'Measurable ROI across campaigns.', icon: '📊' },
              { title: '24/7 Support', desc: 'Always available for peace of mind.', icon: '🕒' },
              { title: 'Experienced Pros', desc: 'Certified experts across domains.', icon: '🧠' },
              { title: 'Global Perspective', desc: 'Serving clients worldwide.', icon: '🌍' },
            ].map((f, idx) => (
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold text-white">A Track Record of Excellence.</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-white border rounded-2xl p-8 text-center shadow-sm" data-aos="fade-up">
              <div className="text-4xl font-extrabold text-gray-900">
                <Counter to={150} suffix="+" />
              </div>
              <div className="text-gray-600 mt-2">Projects Completed</div>
            </div>
            <div className="bg-white border rounded-2xl p-8 text-center shadow-sm" data-aos="fade-up" data-aos-delay="100">
              <div className="text-4xl font-extrabold text-gray-900">
                <Counter to={200} suffix="+" />
              </div>
              <div className="text-gray-600 mt-2">Websites Secured</div>
            </div>
            <div className="bg-white border rounded-2xl p-8 text-center shadow-sm" data-aos="fade-up" data-aos-delay="200">
              <div className="text-4xl font-extrabold text-gray-900">
                <Counter to={98} suffix="%" />
              </div>
              <div className="text-gray-600 mt-2">Client Retention</div>
            </div>
            <div className="bg-white border rounded-2xl p-8 text-center shadow-sm" data-aos="fade-up" data-aos-delay="300">
              <div className="text-4xl font-extrabold text-gray-900">
                <Counter to={5} suffix="+" />
              </div>
