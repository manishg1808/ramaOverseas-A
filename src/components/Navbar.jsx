...
const Navbar = () => {
  ...
  const digitalMarketingServices = [
    { name: t('services.dm.seoOptimization'), icon: 'ri-focus-3-line' },
    { name: t('services.dm.ppcManagement'), icon: 'ri-bar-chart-line' },
    { name: t('services.dm.socialMediaGrowth'), icon: 'ri-smartphone-line' },
    { name: t('services.dm.brandingStrategy'), icon: 'ri-palette-line' },
  ]

  const cyberSecurityServices = [
    { name: t('services.cs.firewallSetup'), icon: 'ri-shield-check-line' },
    { name: t('services.cs.securityAudit'), icon: 'ri-search-line' },
    { name: t('services.cs.threatProtection'), icon: 'ri-lock-password-line' },
    { name: t('services.cs.dataRecovery'), icon: 'ri-database-2-line' },
  ]
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <div className="relative">
                <span className="text-2xl font-bold text-gray-900 group-hover:text-primary-blue transition-colors duration-300">
                  S
                  <span className="absolute -top-1 -left-1 text-xs shield-icon">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              >
                <button className="hover-underline font-medium text-gray-700 flex items-center">
                  {t('nav.services')} <i className="ri-arrow-down-s-line ml-1"></i>
                </button>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                      ...
                      <div className="pr-6">
                        <h3 className="font-bold text-primary-blue mb-4 flex items-center gap-2 text-lg">
                          <i className="ri-computer-line"></i> <span>{t('services.dm.title')}</span>
                        </h3>
                        <ul className="space-y-1.5">
                          {digitalMarketingServices.map((service, idx) => (
                            <li key={idx} className="group flex items-center gap-3 px-2 py-2 rounded-md text-[15px] text-slate-700 hover:bg-primary-blue/5 hover:text-primary-blue transition-colors">
                              <i className={`${service.icon} shrink-0 text-base`}></i>
                      ...
                      <div className="pl-6 border-l border-gray-100">
                        <h3 className="font-bold text-primary-blue mb-4 flex items-center gap-2 text-lg">
                          <i className="ri-lock-password-line"></i> <span>{t('services.cs.title')}</span>
                        </h3>
                        <ul className="space-y-1.5">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  <i className="ri-global-line h-4 w-4 text-gray-600 group-hover:text-primary-blue transition-colors"></i>
            ...
            <div className="container mx-auto px-4 py-4 space-y-4">
              ...
              <div className="py-2">
                ...
                >
                  ...
                  <i className={`ri-arrow-down-s-line transition-transform ${isMobileServicesOpen ? 'rotate-180' : ''}`}></i>
                </button>
                {isMobileServicesOpen && (
                  <div className="pl-4 space-y-2">
                    ...
                    {digitalMarketingServices.map((service, idx) => (
                      <div key={idx} className="pl-4 text-sm text-gray-600 flex items-center gap-2">
