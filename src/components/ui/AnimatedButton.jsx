...
const AnimatedButton = ({ onClick, children }) => {
  return (
    <StyledWrapper>
      <button type="button" onClick={onClick} className="button" aria-label={typeof children === 'string' ? children : 'Action button'}>
        <div className="dots_border" />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="sparkle" aria-hidden="true">
